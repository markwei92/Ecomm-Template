// This script creates a user with the admin API and tests login
...
// Function to create a user with the admin API
...
// Main function
async function main() {
  console.log('Supabase Admin User Creation Test');
  console.log('================================');
